    ...
    <div className='flex justify-center'>
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10'>
        {articles.map((article) => (
          <div key={article.id} className='group h-[607px] w-full md:w-[410px] p-4'>
            <div className='w-full'>
              ...
              <div className='bg-gray-300 hover:bg-white w-full h-[277px] p-4 shadow-md'>
                ...
                <p className='text-gray-700 text-sm mt-4 text-left leading-[26px]'>
                  L&rsquo;iPhone d&rsquo;Apple était une innovation majeure dans l&rsquo;industrie de la téléphonie mobile.
                </p>
